...
class PredictionPipeline:
    ...
    def save_input_file(self) -> str:
        try:
            ...
            pred_file_path= os.join.path(pred_file_input_dir, input_csv_file.name)
    ...
    def predict(self, features):
        try:
            ...
            model = self.load_object(self.prediction_pipeline_config.model_file_path)
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        try:
            ...
            input_dataframe = input_dataframe_path.drop(columns="Unnamed: 0") if "Unnamed: 0" in input_dataframe.columns else input_dataframe
            ...
            os.makedir(self.prediction_piprline_config.pridiction_output_dirname, exist_ok=True)
