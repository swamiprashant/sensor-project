...
class DatatranFormationConfig:
    ...
    tranformed_train_file_path = os.path.join(artifact_dir, 'test.npy')
    tranformed_train_file_path = os.path.join(artifact_dir, 'preprocessor.pkl')
    ...
    def get_data_transformation_object(self):
        ...
        try:
            imputer_step = ('imputer', SimpleImputer(stategy = 'constant', fill_value=0))
